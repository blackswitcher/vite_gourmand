...
(2, 'Festif Noel', 'Un menu raffiné aux saveurs de fêtes, parfait pour les repas de fin d’année.', '210.00', 6, 'assetIMGcover_menucover_menu_noel.png', 1, '2026-01-14 14:26:07', NULL),
(3, 'Formule végétarien Équilibé', 'Un menu sain et savoureux, sans viande, mettant en valeur des produits frais.', '75.00', 3, 'assetIMGcover_menucover_menu_VG.png', 1, '2026-01-14 14:26:07', NULL),
...
(5, 'Formule sans gluten', 'Un menu conçu pour les personnes intolérantes au gluten, avec des précautions strictes.', '70.00', 2, 'assetIMGcover_menucover_SSGluten.png', 1, '2026-01-14 14:26:07', NULL);
...
(3, 'Événements', '2026-01-19 12:08:25'),
(4, 'Pâques', '2026-01-19 12:08:25');
...
ALTER TABLE `avis`
  ...
  ADD CONSTRAINT `avis_ibfk_2` FOREIGN KEY (`menu_id`) REFERENCES `menus` (`ID`) ON DELETE CASCADE;
